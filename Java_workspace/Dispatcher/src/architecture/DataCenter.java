...
public class DataCenter {
	public  Map<Integer,RackGroup> group_map = new HashMap<Integer,RackGroup>();
	...
	public void addGroup(RackGroup g)
	{
		group_map.put(g.group_id,g);
	}
	
	public Iterator<RackGroup> getGroupList()
	{
		return group_map.values().iterator();
	}
