...
public class Rack {
	...
	public int rack_id;			/*unique id for each rack*/
	public int group_id;
	public int datacenter_id;
	public int rack_traffic;
	public int status;//0-关,1-开
	public Map<Integer,Node> node_map=new HashMap<Integer,Node>();
...
//	}
	...
	public void addNC(Node node)
	{
		node_map.put(node.node_id, node);
	}
