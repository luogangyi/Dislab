...
public class DatacenterBuilder {
	...
	{
		DatacenterBuilder.log = log;
		DatacenterBuilder.datacenter_id = 0;
		DatacenterBuilder.datacenter = new DataCenter();
	}
	public static void initiateDataCenter() throws Exception
	{
		//初始化机架组，并将其添加至数据中心中
		initiateGroup();
		//初始化机架，并将其添加至机架组中
	...
	private static boolean initiateGroup() throws Exception
	{
	...
	private static boolean initiateRack() throws Exception
	{
	...
	private static boolean initiateNC() throws Exception
	{
		...
		try{
            ...
            while(rs.next()) {
            	...
            	Node n = new Node(cpu,mem,IP,virtType,nc_id,rack_id,group_id,datacenter_id,r,g,datacenter,nc_status,update_at);
	...
	public static boolean updateNC() throws Exception
	{
		...
		try{
            ...
            while(rs.next()) {
            	...
            	//System.out.println("GroupID:"+group_id+" RackID:"+rack_id+" NCID:"+nc_id);
