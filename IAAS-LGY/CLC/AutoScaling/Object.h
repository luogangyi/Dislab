...
public:
	...
	bool sendData2CLC(const char * data, int len, int sock);
	bool recvData(int sock, String& data);
	bool recvDataFromCLC(int sock, String& data);
	...
	bool sendData2NC(const char * data, int len, int sock);
	bool recvDataFromNC(int sock, String& data);
